...
cp /path/to/serp_api.py ~/serp/
cp /path/to/requirements.txt ~/serp/
cp /path/to/.env ~/serp/
...
sudo cp /path/to/serp-api.service /etc/systemd/system/
...
sudo cp /path/to/serp.sdad.pro /etc/nginx/sites-available/
